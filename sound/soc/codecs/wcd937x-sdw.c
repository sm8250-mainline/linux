...
static struct wcd937x_sdw_ch_info wcd937x_sdw_tx_ch_info[] = {
	WCD_SDW_CH(WCD937X_ADC1, WCD937X_SDW_PORT0, BIT(0)), //TX1
	WCD_SDW_CH(WCD937X_ADC2, WCD937X_SDW_PORT0, BIT(1)), //TX1
	WCD_SDW_CH(WCD937X_ADC3, WCD937X_SDW_PORT1, BIT(0)), //TX1
	WCD_SDW_CH(WCD937X_ADC4, WCD937X_SDW_PORT1, BIT(1)), //TX1
	WCD_SDW_CH(WCD937X_DMIC0, WCD937X_SDW_PORT2, BIT(0)), //TX2
	WCD_SDW_CH(WCD937X_DMIC1, WCD937X_SDW_PORT2, BIT(1)), //TX2
	// WCD_SDW_CH(WCD937X_MBHC, WCD937X_SDW_PORT2, BIT(2)), //TX2
	WCD_SDW_CH(WCD937X_DMIC2, WCD937X_SDW_PORT2, BIT(2)), //TX2
	WCD_SDW_CH(WCD937X_DMIC3, WCD937X_SDW_PORT2, BIT(3)), //TX2
	WCD_SDW_CH(WCD937X_DMIC4, WCD937X_SDW_PORT3, BIT(0)), //TX3
	WCD_SDW_CH(WCD937X_DMIC5, WCD937X_SDW_PORT3, BIT(1)), //TX3
	WCD_SDW_CH(WCD937X_DMIC6, WCD937X_SDW_PORT3, BIT(2)), //TX3
	WCD_SDW_CH(WCD937X_DMIC7, WCD937X_SDW_PORT3, BIT(3)), //TX3
};
...
static bool wcd937x_readable_register(struct device *dev, unsigned int reg)
{
	...
	ret = wcd937x_readonly_register(dev, reg);
	if (!ret)
